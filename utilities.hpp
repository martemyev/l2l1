...
/**
 * Check a class invariant is meant under self check.
 */
#if defined(SELFCHECK)
  #define selfcheck(condition) require(condition, "The self check failed")
#else
  #define selfcheck(condition) { }
#endif // SELFCHECK
...
/**
 * @brief Get memory consumption
 *
 * Get the size (in KB) of virtual and physical memory consumed by the process
 */
void get_memory_consumption(int &physical_memory, int &virtual_memory);
